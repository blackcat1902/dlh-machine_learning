#!/usr/bin/env python3
"""
This module calculates the posterior probability for various hypothetical
probabilities of developing severe side effects given the observed data.
"""
import numpy as np
...
def posterior(x, n, P, Pr):
    ...
    Returns:
        numpy.ndarray: 1D array containing the posterior probability for each
